...
class DriverLoginFromSeeker extends StatefulWidget {
  static String tag = 'login-page';

  const DriverLoginFromSeeker({
    Key key,
  }) : super(key: key);

  @override
  _DriverLoginFromSeekerState createState() => new _DriverLoginFromSeekerState();
}

class _DriverLoginFromSeekerState extends State<DriverLoginFromSeeker> {
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                Text(
                                  "If you dont have driver account,",
                                  style: TextStyle(
                                      color:
                                      Colors.white60),
                                ),
